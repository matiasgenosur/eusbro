          ...
          <div className="space-y-8">
            <div>
              ...
              <a
                ...
                className="inline-flex items-center gap-3 text-lg px-8 py-4 rounded-lg font-semibold text-white bg-[#25D366] hover:bg-[#128C7E] transition-all hover:-translate-y-0.5 hover:shadow-lg"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
              ...
              <p className="text-gray-400 text-sm mt-3">+56 9 6609 1092</p>
            </div>
